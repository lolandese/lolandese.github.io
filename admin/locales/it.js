...
export const strings = {
  ...
  password: 'Password',
  sign_in: 'Accedi',
  sign_in_with_mobile: 'Accedi con mobile',
  ...
  signed_in_as_x: 'Connesso come {name}',
  ...
  // Common errors
  clipboard_error: 'Si è verificato un errore durante la copia dei dati.',
  ...
  loading_site_data_error: 'Si è verificato un errore durante il caricamento dei dati del sito.',
  sign_in_with_x: 'Accedi con {service}',
  sign_in_with_x_using_token: 'Accedi con {service} usando token',
  sign_in_using_pat_title: 'Accedi usando Personal Access Token',
  sign_in_using_pat_description:
    'Immetti il tuo token di seguito. Deve avere accesso in lettura/scrittura al contenuto del repository.',
  sign_in_using_pat_link: 'Puoi generare un token nella <a>pagina delle impostazioni utente di {service}</a>.',
  personal_access_token: 'Token di accesso personale',
  authorizing: 'Autorizzazione in corso…',
  signing_in: 'Accesso in corso…',
  work_with_local_repo: 'Lavora con il repository locale',
  ...
  work_with_local_repo_description_no_repo:
    'Quando richiesto, seleziona la directory radice del tuo repository Git.',
  work_with_test_repo: 'Lavora con il repository di test',
  sign_in_error: {
    not_project_root:
      'The folder you have selected is not a repository root directory. Please try again.',
    picker_dismissed: 'Non è stato possibile selezionare una directory radice del repository. Riprova.',
    authentication_aborted: 'Autenticazione annullata. Riprova.',
    invalid_token: 'Il token fornito non è valido. Controlla e riprova.',
    // Errors defined in Sveltia CMS Authenticator
    // https://github.com/sveltia/sveltia-cms-auth/blob/main/src/index.js
    UNSUPPORTED_BACKEND: 'Il tuo backend Git non è supportato dall\'autenticatore.',
    UNSUPPORTED_DOMAIN: 'Il tuo dominio non è autorizzato a utilizzare l\'autenticatore.',
    MISCONFIGURED_CLIENT: 'L\'ID client o il segreto dell\'app OAuth non sono configurati.',
    AUTH_CODE_REQUEST_FAILED: 'Errore nel ricevimento del codice di autorizzazione. Riprova più tardi.',
    CSRF_DETECTED: 'Potenziale attacco CSRF rilevato. Flusso di autenticazione annullato.',
    TOKEN_REQUEST_FAILED: 'Errore nella richiesta del token di accesso. Riprova più tardi.',
    TOKEN_REFRESH_FAILED: 'Errore nell\'aggiornamento del token di accesso. Riprova più tardi.',
    MALFORMED_RESPONSE: 'Il server ha risposto con dati malformati. Riprova più tardi.',
  },
  backend_unsupported_version: 'Il backend {name} richiede {name} {version} o versione successiva.',
  ...
  // Parser errors
  entry_parse_error:
    'Si è verificato un errore durante l\'analisi di un file di voce. Controlla la console del browser per i dettagli.',
  entry_parse_errors:
    'Si sono verificati errori durante l\'analisi dei file di voce. Controlla la console del browser per i dettagli.',

  // Onboarding
  mobile_promo_title: 'Sveltia CMS è ora disponibile su mobile!',
  mobile_promo_button: 'Provalo',

  // Global toolbar
  visit_live_site: 'Visita il sito live',
  switch_page: 'Cambia pagina',
  search_placeholder_entries: 'Cerca voci…',
  search_placeholder_assets: 'Cerca risorse…',
  search_placeholder_all: 'Cerca voci e risorse…',
  create_entry_or_assets: 'Crea voce o risorse',
  publish_changes: 'Pubblica modifiche',
  publishing_changes: 'Pubblicazione delle modifiche…',
  publishing_changes_failed: 'Le modifiche non potevano essere pubblicate. Riprova più tardi.',
  show_notifications: 'Mostra notifiche',
  notifications: 'Notifiche',
  show_account_menu: 'Mostra menu account',
  account: 'Account',
  live_site: 'Sito live',
  git_repository: 'Repository Git',
  settings: 'Impostazioni',
  cms_config: 'Configurazione del CMS',
  show_help_menu: 'Mostra menu aiuto',
  help: 'Aiuto',
  keyboard_shortcuts: 'Scorciatoie da tastiera',
  documentation: 'Documentazione',
  release_notes: 'Note di rilascio',
  announcements: 'Annunci',
  version_x: 'Versione {version}',
  report_issue: 'Segnala un problema',
  share_feedback: 'Condividi feedback',
  get_help: 'Ottieni aiuto',
  join_discord: 'Unisciti a noi su Discord',
  bluesky: 'Seguici su Bluesky',

  // Update notification
  update_available: 'L\'ultima versione di Sveltia CMS è disponibile.',
  update_now: 'Aggiorna ora',

  // Backend status indicator
  backend_status: {
    minor_incident:
      '{service} sta subendo un incidente minore. Il tuo flusso di lavoro potrebbe essere potenzialmente interessato.',
    major_incident:
      '{service} sta subendo un incidente importante. Potresti voler aspettare fino a quando la situazione è migliorata.',
  },

  // Library
  content_library: 'Libreria contenuti',
  asset_library: 'Libreria risorse',
  asset_location: {
    repository: 'Il tuo sito',
    external: 'Posizioni esterne',
    stock_photos: 'Foto di stock',
  },
  collection_assets: 'Risorse collezione',
  entry_list: 'Elenco voci',
  file_list: 'Elenco file',
  asset_list: 'Elenco risorse',
  ...
  one_asset: 'una risorsa',
  no_assets: 'nessuna risorsa',
  ...
  replace_asset: 'Sostituisci risorsa',
