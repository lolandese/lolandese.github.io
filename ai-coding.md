...
**Iteration becomes productive.** Coding with AI rarely consists of one prompt request and all is done. I review what it generates, spot what needs adjustment, and refine my requests. This back-and-forth works best when I can say "that's close, but use this Drupal API call instead of pure PHP" or "add error handling for null values."

**I maintain architectural vision.** AI assistants excel at implementing specific functions or components, but higher-level decisions about how pieces fit together should still be made by me: what libraries to use and how to structure the project. That architectural thinking comes from experience.
